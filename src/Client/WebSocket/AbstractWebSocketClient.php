...
namespace Mytryk\AriClient\Client\WebSocket;
...
use JsonException;
use Mytryk\AriClient\Client\Rest\Resource\Applications;
use Mytryk\AriClient\Client\Rest\Settings as RestClientSettings;
use Mytryk\AriClient\Exception\AsteriskRestInterfaceException;
use Mytryk\AriClient\Helper;
use Mytryk\AriClient\StasisApplicationInterface;
 ...
 *
 * @package Mytryk\AriClient\Client\WebSocket
 *
...
abstract class AbstractWebSocketClient implements WebSocketClientInterface
{
    ...
    private function extractHandledAsteriskEvents(array $myAppPublicMethodNames): array
    {
        ...
        foreach ($myAppPublicMethodNames as $methodName) {
            ...
            if (
                !class_exists("Mytryk\\AriClient\\Model\\Message\\Event\\" . $eventName)
            ) {
                $errorMessage = sprintf(
    ...
    public function onMessageHandlerLogic(string $ariEventAsJson): void
    {
        ...
        $ariEventNamespace =
            "Mytryk\\AriClient\\Model\\Message\\Event\\" . $ariEventType;
