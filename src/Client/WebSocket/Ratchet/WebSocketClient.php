...
namespace Mytryk\AriClient\Client\WebSocket\Ratchet;

use Exception;
use Mytryk\AriClient\Client\WebSocket\{AbstractWebSocketClient, Settings as WebSocketClientSettings};
 ...
 *
 * @package Mytryk\AriClient\Client\WebSocket\Ratchet
 *
